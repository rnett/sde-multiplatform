...
actual class invmarketgroup(val myId: EntityID<Int>) : IntEntity(myId) {
    ...
    val parentGroup: invmarketgroup by invmarketgroup referencedOn invmarketgroups.parentGroup


    // Referencing/Exported Keys (One to Many)

    val invmarketgroups_rk: SizedIterable<invmarketgroup> by invmarketgroup referrersOn invmarketgroups.parentGroup
    val invtypes_rk: SizedIterable<invtype> by invtype referrersOn invtypes.marketGroup
